# [thomasWeise/docker-pandoc](https://hub.docker.com/r/thomasweise/docker-pandoc/)

[![Docker Pulls](https://img.shields.io/docker/pulls/thomasweise/docker-pandoc.svg)](https://hub.docker.com/r/thomasweise/docker-pandoc/)
[![Docker Stars](https://img.shields.io/docker/stars/thomasweise/docker-pandoc.svg)](https://hub.docker.com/r/thomasweise/docker-pandoc/)

This is a Docker image containing a [`pandoc`](http://pandoc.org/) installation which can make use of our [`TeX Live`](http://en.wikipedia.org/wiki/TeX_Live) installation from container [thomasWeise/texlive-full](https://hub.docker.com/r/thomasweise/docker-texlive-full/), which in turn provides some useful scripts and several fonts.
